...
export default class extends React.Component {
  ...
  constructor(props) {
    ...
    this.subjects = [new Planes(this, this.state.image)];
  ...
  addImagePlane() {
    ...
    const geometry = new THREE.PlaneBufferGeometry(width, viewSize.height * 0.8, 1, 1);
  ...
  initTextPlane() {
    ...
    const geometry = new THREE.PlaneBufferGeometry(viewSize.width, viewSize.height, 1, 1);
